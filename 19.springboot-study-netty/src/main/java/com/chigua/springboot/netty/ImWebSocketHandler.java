package com.chigua.springboot.netty;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.chigua.springboot.model.SocketMessage;
import com.chigua.springboot.service.UserGroupService;
import com.chigua.springboot.utils.SpringUtil;
 ...
 * ClassName: com.chigua.springboot.netty.ImWebSocketHandler
 *
...
public class ImWebSocketHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    private final Logger logger = LoggerFactory.getLogger(ImWebSocketHandler.class);
     ...
     * 获取用户拥有的群聊id号
     */
    UserGroupService userGroupService = SpringUtil.getBean(UserGroupService.class);
